        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'catalog_post' ? 'active' : '' }}">
                        <a href="{{ url('admin/catalog_post/list') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Danh mục bài viết
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/catalog_post/list') }}">Thêm mới</a></li>
                            <li><a href="{{ url('admin/catalog_post/list') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-link {{ $module_active == 'catalog' ? 'active' : '' }}">
                        <a href="{{ url('admin/catalog/list') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Danh mục sản phẩm
                        ...
                        <i class="arrow fas fa-angle-down"></i>
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/catalog/list') }}">Thêm mới</a></li>
                            <li><a href="{{ url('admin/catalog/list') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    ...
                    {{-- <li class="nav-link active">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="{{ url('') }}">Quyền</a></li>
                            <li><a href="{{ url('') }}">Thêm vai trò</a></li>
                            <li><a href="{{ url('') }}">Danh sách vai trò</a></li>
                        </ul>
                    </li> --}}
