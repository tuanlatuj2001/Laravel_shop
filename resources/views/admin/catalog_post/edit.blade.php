        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('catalog_post.update', $cat->catalog_post_id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">Tên danh mục</label>
                                <input class="form-control" type="text" name="catalog_post_name" id="name"
                                    value="{{ $cat->catalog_post_name }}">
                                ...
                                <select class="form-control" name="parent_id" id="">
                                    ...
                                    @foreach ($catalogs as $item)
                                        <option value="{{ $item['catalog_post_id'] }}"
                                            {{ $cat->parent_id == $item['catalog_post_id'] ? 'selected' : '' }}>
                                ...
                                @foreach ($catalogs as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('delete.catalog', $cat->catalog_post_id) }}"
