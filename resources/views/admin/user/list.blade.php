    ...
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                <h4 class="m-0 ">Danh sách thành viên</h4>
                <div class="form-search form-inline">
                    <form action="#">
                        <input type="text" name="keyword" class="form-control form-search"
                            value="{{ request()->input('keyword') }}" placeholder="Tìm kiếm " style="margin-right:0px">
                ...
                <form action="{{ url('admin/user/action') }}" method="">
                    ...
                    <table class="table table-striped table-checkall">
                        ...
                        <tbody>
                            ...
                            @else
                                <tr class="">
                                    <td colspan="/" class="bg-white">Không tìm thây bản ghi !!</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
